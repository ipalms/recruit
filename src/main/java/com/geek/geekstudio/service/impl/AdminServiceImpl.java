...
public class AdminServiceImpl implements AdminService {
    ...
    public RestInfo queryAdmins(int page, int rows, String courseName, String adminName, String adminId) {
        int total=adminMapper.queryAdminTotal(courseName,adminName,adminId);
        int start=(page-1)*rows;
        List<AdminPO> adminPOList=adminMapper.queryAdmins(courseName,adminName,adminId,start,rows);
